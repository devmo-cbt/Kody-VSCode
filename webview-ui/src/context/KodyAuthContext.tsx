...
export interface KodyAuthContextType {
	kodyUser: KodyUser | null
	organizations: UserOrganization[] | null
	activeOrganization: UserOrganization | null
}

export const KodyAuthContext = createContext<KodyAuthContextType | undefined>(undefined)

export const KodyAuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [user, setUser] = useState<KodyUser | null>(null)
	...
	useEffect(() => {
		console.log("Extension: KodyAuthContext: user updated:", user?.uid)
	}, [user?.uid])
...
export const useKodyAuth = () => {
	const context = useContext(KodyAuthContext)
	if (context === undefined) {
		throw new Error("useKodyAuth must be used within a KodyAuthProvider")
	}
	return context
}

export const useKodySignIn = () => {
