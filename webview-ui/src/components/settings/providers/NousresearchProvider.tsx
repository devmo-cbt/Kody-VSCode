				...
				<>
					...
					<p
						...
						<span style={{ color: "var(--vscode-errorForeground)" }}>
							(<span style={{ fontWeight: 500 }}>Note:</span> Kody uses a local model hosted on internal
							infrastructure. Less capable models. Less capable models may not work as expected.)
						</span>
					</p>
				</>
			)}
