...
import { SapAiCoreModelDeployment } from "@shared/proto/index.kody"
...
const SapAiCoreModelPicker: React.FC<SapAiCoreModelPickerProps> = ({
	...
	const categorizedModels = useMemo(() => {
		...
		// Models that are both deployed AND supported in Kody
		...
		// Models that are supported in Kody but NOT deployed
