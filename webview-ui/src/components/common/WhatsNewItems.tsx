import type { BannerAction, BannerCardData } from "@shared/kody/banner"
		...
		<ul className="text-sm pl-3 list-disc" style={{ color: "var(--vscode-descriptionForeground)" }}>
			{hasWelcomeBanners ? (
				...
				<>
					...
					<li className="mb-2">
						<strong>Try Codex 5.3:</strong> OpenAI's latest coding model, now available in Kody!{" "}
						<InlineModelLink label="Try now" modelId="openai/gpt-5.3-codex" pickerTab="recommended" />
					</li>
					<li className="mb-2">
						<strong>Try latest SOTA coding model:</strong> Claude Sonnet 4.6 and Gemini 3.1 pro within Kody!{" "}
						<InlineModelLink label="Try now" modelId="anthropic/claude-sonnet-4.6" pickerTab="recommended" />
					</li>
					<li className="mb-2">
						<strong>Try Kody CLI 2.0:</strong> with /mcp functionality added in CLI{" "}
						<code style={inlineCodeStyle}>npm install -g kody</code>
					</li>
					<li className="mb-2">
