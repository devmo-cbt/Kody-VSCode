...
const createTextMessage = (ts: number, text: string): KodyMessage => ({
	type: "say",
	say: "text",
	text,
	ts,
...
const createToolMessage = (ts: number, tool: string): KodyMessage => ({
	type: "say",
	say: "tool",
...
const createReasoningMessage = (ts: number, text: string): KodyMessage => ({
	type: "say",
	say: "reasoning",
	text,
	ts,
