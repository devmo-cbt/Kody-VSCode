...
export function useScrollBehavior(
	...
	const [scrolledPastUserMessage, setScrolledPastUserMessage] = useState<KodyMessage | null>(null)
	...
	const checkScrolledPastUserMessage = useCallback(() => {
		...
		let mostRecentScrolledPast: KodyMessage | null = null
