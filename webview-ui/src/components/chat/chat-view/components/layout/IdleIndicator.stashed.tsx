 ...
 */
export function useIdleIndicator(scrollContainerRef: React.RefObject<HTMLDivElement>, kodyMessages: KodyMessage[]): boolean {
	...
	useEffect(() => {
		...
		const isTaskComplete = kodyMessages.some(
	...
	}, [scrollContainerRef, kodyMessages])
