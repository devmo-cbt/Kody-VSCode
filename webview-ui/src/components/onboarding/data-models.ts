import type { OpenRouterModelInfo } from "@shared/proto/kody/models"
import type { OnboardingModel, OnboardingModelGroup } from "@shared/proto/kody/state"
...
export function getKodyUIOnboardingGroups(groupedModels: OnboardingModelGroup): OnboardingModelsByGroup {
