...
function setupHostProvider(extensionContext: any, extensionDir: string, dataDir: string) {
	...
	// kody-core expects the binaries to be unpacked in the directory where it is running.
...
/**
 * Gracefully shutdown the kody-core process by:
...
function showHelp() {
	Logger.log(`
Kody Core - Standalone Server

Usage: node kody-core.js [options]
...
Options:
  ...
  -c, --config <path>            Directory for Kody data storage (default: ~/.kody)
