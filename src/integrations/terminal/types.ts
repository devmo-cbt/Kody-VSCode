...
import type { KodyToolResponseContent } from "@shared/messages"
...
export interface CommandExecutorCallbacks {
	...
	/**
	 * Update a kody message by index
	 * Supports updating commandCompleted status and/or text content
	 */
	updateKodyMessage: (index: number, updates: { commandCompleted?: boolean; text?: string }) => Promise<void>
	/** Get kody messages array */
	getKodyMessages: () => Array<{ ask?: string; say?: string; text?: string }>
...
export interface OrchestrationResult {
	...
	result: KodyToolResponseContent
