...
import type { KodyAPI } from "../exports/kody"
import { setVscodeHostProviderMock } from "./host-provider-test-utils"

describe("KodyAPI Core Functionality", () => {
	let api: KodyAPI
	...
	beforeEach(async () => {
		...
		// Create a mock controller that matches what the real createKodyAPI expects
		...
		// Create API instance
		api = createKodyAPI(mockController)
	})
