...
export const addSelectedCodeToKodyWebview = async (_page: Page) => {
	...
	const addToKody = _page.getByText(/Add to Kody/i)
	await addToKody.waitFor({ state: "visible" })
