import { clearOnboardingModelsCache, getKodyOnboardingModels } from "@/core/controller/models/getKodyOnboardingModels"
import type { OnboardingModel } from "@/shared/proto/kody/state"
...
export class FeatureFlagsService {
	...
	public async poll(userId: string | null): Promise<void> {
		...
		getKodyOnboardingModels() // Refresh onboarding models cache if relevant flag changed
	}
