...
import type { KodyError } from "../KodyError"
...
export interface IErrorProvider {
	 ...
	 */
	captureException(error: Error | KodyError, properties?: Record<string, unknown>): Promise<void>

	/**
	 * Sends a log message an error and optional properties
	 * @param error The error to log (Error or KodyError)
	 * @param properties Optional additional properties to attach
	 */
	logException(error: Error | KodyError, properties?: Record<string, unknown>): void
