...
import { buildBasicKodyHeaders } from "../EnvUtils"

export class KodyAccountService {
	private static instance: KodyAccountService
	...
	/**
	 * Returns the singleton instance of KodyAccountService
	 * @returns Singleton instance of KodyAccountService
	 */
	public static getInstance(): KodyAccountService {
		if (!KodyAccountService.instance) {
			KodyAccountService.instance = new KodyAccountService()
		}
		return KodyAccountService.instance
	}

	/**
	 * Returns the base URL for the Kody API
	...
	/**
	 * Helper function to make authenticated requests to the Kody API
	...
	private async authenticatedRequest<T>(endpoint: string, config: AxiosRequestConfig = {}): Promise<T> {
		...
		if (!kodyAccountAuthToken) {
			throw new Error("No Kody account auth token found")
		}
