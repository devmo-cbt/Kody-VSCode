...
export async function regexSearchFiles(
	...
	// Filter results using KodyIgnoreController if provided
	const filteredResults = kodyIgnoreController
		? results.filter((result) => kodyIgnoreController.validateAccess(result.filePath))
		: results
