 ...
 */
export const _GENERATED_MACHINE_ID_KEY = "kody.generatedMachineId"
 ...
 * This is updated to Kody User ID when authenticated.
 */
 ...
 * If authenticated, this will be the Kody User ID.
