 ...
 */
export function convertApplyPatchToolCalls(messages: Array<KodyStorageMessage>): Array<KodyStorageMessage> {
 ...
 */
export function convertWriteToFileToolCalls(messages: Array<KodyStorageMessage>): Array<KodyStorageMessage> {
	// Map to track tool_use_id to converted tool info and original input
