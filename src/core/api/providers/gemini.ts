...
export class GeminiHandler implements ApiHandler {
	...
	async *createMessage(systemPrompt: string, messages: KodyStorageMessage[], tools?: GoogleTool[]): ApiStream {
		...
		try {
			...
			if (error instanceof Error) {
				...
				if (error instanceof ApiError) {
					...
					// https://github.com/kody/kody/pull/5205#discussion_r2311761559
