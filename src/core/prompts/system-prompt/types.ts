...
export interface PromptVariant {
	...
	// Tool configuration
	readonly tools?: readonly KodyDefaultTool[] // Ordered list of tools to include
	readonly toolOverrides?: Readonly<Partial<Record<KodyDefaultTool, ConfigOverride>>> // Tool customizations
}
...
export interface MutablePromptVariant {
	...
	tools?: KodyDefaultTool[]
	toolOverrides?: Partial<Record<KodyDefaultTool, ConfigOverride>>
}
...
export interface PromptConfig {
	...
	readonly tools?: readonly KodyToolSpec[]
...
export interface SystemPromptContext {
	...
	readonly globalKodyRulesFileInstructions?: string
	readonly localKodyRulesFileInstructions?: string
	...
	readonly kodyIgnoreInstructions?: string
	...
	readonly kodyWebToolsEnabled?: boolean
...
export type ToolKey = keyof typeof KodyDefaultTool
export type ToolValue = (typeof KodyDefaultTool)[ToolKey]
...
export function isValidKodyDefaultTool(tool: string): tool is KodyDefaultTool {
	return Object.values(KodyDefaultTool).includes(tool as KodyDefaultTool)
}
...
export interface VariantBuilder {
	...
	tools(...tools: KodyDefaultTool[]): this
	overrideTool(tool: KodyDefaultTool, override: ConfigOverride): this
...
export const TASK_PROGRESS_PARAMETER = {
	...
	dependencies: [KodyDefaultTool.TODO],
}
