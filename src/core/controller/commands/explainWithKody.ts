...
export async function explainWithKody(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
...
\`\`\`${request.language}\n${request.selectedText}\n\`\`\``
	...
	if (notebookContext) {
		Logger.log("Adding notebook context to explainWithKody task")
