...
export async function improveWithKody(controller: Controller, request: CommandContext, notebookContext?: string): Promise<Empty> {
	...
	if (notebookContext) {
		Logger.log("Adding notebook context to improveWithKody task")
		prompt += `\n${notebookContext}`
	}
