import type { ToggleAgentsRuleRequest } from "@shared/proto/kody/file"
 ...
 */
export async function toggleAgentsRule(controller: Controller, request: ToggleAgentsRuleRequest): Promise<KodyRulesToggles> {
	...
	return KodyRulesToggles.create({
