import type { ToggleCursorRuleRequest } from "@shared/proto/kody/file"
 ...
 */
export async function toggleCursorRule(controller: Controller, request: ToggleCursorRuleRequest): Promise<KodyRulesToggles> {
