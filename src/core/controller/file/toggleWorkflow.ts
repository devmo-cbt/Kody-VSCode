import { KodyRulesToggles, RuleScope, ToggleWorkflowRequest } from "@shared/proto/kody/file"
 ...
 */
export async function toggleWorkflow(controller: Controller, request: ToggleWorkflowRequest): Promise<KodyRulesToggles> {
