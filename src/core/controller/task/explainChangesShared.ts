...
If the user asks you to make changes, fix something, or do any work that requires modifying code, let them know they can click the "Add to Kody Chat" button (the arrow icon in the top-right of the comment box) to send this conversation to the main Kody agent, which can then make the requested changes.
`
 ...
 */
export function stringifyConversationHistory(apiConversationHistory: KodyStorageMessage[]): string {
