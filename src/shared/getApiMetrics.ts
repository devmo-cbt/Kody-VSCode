...
/**
 * Calculates API metrics from an array of KodyMessages.
 *
 ...
 */
export function getApiMetrics(messages: KodyMessage[]): ApiMetrics {
 ...
 */
export function getLastApiReqTotalTokens(messages: KodyMessage[]): number {
