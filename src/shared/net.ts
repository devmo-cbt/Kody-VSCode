 ...
 * ## Proxy Support
 *
 * Kody uses platform-specific fetch implementations to handle proxy
 * configuration:
 ...
 * 3. View logs: Check ~/.kody/kody-core-service.log for network-related
 *    failures.
