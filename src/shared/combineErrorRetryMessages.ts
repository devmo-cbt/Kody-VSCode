 ...
 * @returns A new array of KodyMessage objects with error_retry sequences consolidated.
 *
 * @example
 ...
 */
export function combineErrorRetryMessages(messages: KodyMessage[]): KodyMessage[] {
