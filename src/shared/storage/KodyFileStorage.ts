...
import { KodySyncStorage } from "./KodyStorage"

export interface KodyFileStorageOptions {
	/**
 ...
 */
export class KodyFileStorage<T = any> extends KodySyncStorage<T> {
	protected name: string
	private data: Record<string, T>
	private readonly fsPath: string
	private readonly fileMode?: number

	constructor(filePath: string, name = "KodyFileStorage", options?: KodyFileStorageOptions) {
		super()
