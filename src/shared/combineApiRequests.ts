...
/**
 * Combines API request start and finish messages in an array of KodyMessages.
 *
 ...
 * @returns A new array of KodyMessage objects with API requests combined.
 *
 * @example
 * const messages = [
 ...
 */
export function combineApiRequests(messages: KodyMessage[]): KodyMessage[] {
	const combinedApiRequests: KodyMessage[] = []
