...
// Kody Provider model schema with per-model settings
export const KodyModelSchema = z.object({
	id: z.string(), // The model ID is required
})

// Kody Provider specific settings
export const KodySettingsSchema = z.object({
	// A list of the allowed models with their settings
	models: z.array(KodyModelSchema).optional(),
})
...
const ProviderSettingsSchema = z.object({
	...
	Kody: KodySettingsSchema.optional(),
...
// Settings for a global kody rules or workflow file.
