...
/**
 * Combines sequences of command and command_output messages in an array of KodyMessages.
 *
 * This function processes an array of KodyMessages objects, looking for sequences
 ...
 * their text contents.
 *
 * @param messages - An array of KodyMessage objects to process.
 * @returns A new array of KodyMessage objects with command sequences combined.
 *
 * @example
 ...
 */
export function combineCommandSequences(messages: KodyMessage[]): KodyMessage[] {
	const combinedCommands: KodyMessage[] = []
