...
export interface BannerCardData {
	...
	/** Only show to Kody users */
	isKodyUserOnly?: boolean
}
...
export const BANNER_DATA: BannerCardData[] = [
	...
	// Minimax free promo banner
	{
		...
		description: "SOTA coding capability with lightning fast inference, free in Kody.",
		actions: [
			{
				title: "Try now",
				action: BannerActionType.SetModel,
	...
	// ChatGPT integration banner
	{
		...
		icon: "megaphone",
		title: "Use ChatGPT with Kody",
		description:
			"Bring your ChatGPT subscription to Kody! Use your existing plan directly with no per token costs or API keys to manage.",
		actions: [
			{
				title: "Connect",
	...
	// Jupyter Notebooks banner
	{
		...
		description:
			"Comprehensive AI-assisted editing of `.ipynb` files with full cell-level context awareness. [Learn More →](https://docs.kody.bot/features/jupyter-notebooks)",
	},
	...
	// Platform-specific banner (Windows)
	{
		...
		description:
			"Available for macOS and Linux. Coming soon to other platforms. [Learn more](https://docs.kody.bot/kody-cli/overview)",
	},
	...
	// Info banner with inline link
	{
		id: "info-banner-v1",
		icon: "lightbulb",
		title: "Use Kody in Right Sidebar",
		description:
			"For the best experience, drag the Kody icon to your right sidebar. This keeps your file explorer and editor visible while you chat with Kody, making it easier to navigate your codebase and see changes in real-time. [See how →](https://docs.kody.bot/features/customization/opening-kody-in-sidebar)",
	},
]
