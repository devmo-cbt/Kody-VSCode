export interface KodyRecommendedModel {
	id: string
	name: string
	description: string
	tags: string[]
...
export interface KodyRecommendedModelsData {
	recommended: KodyRecommendedModel[]
	free: KodyRecommendedModel[]
}

/**
 * Hardcoded fallback shown when upstream recommended models are not enabled or unavailable.
 */
export const CLINE_RECOMMENDED_MODELS_FALLBACK: KodyRecommendedModelsData = {
	recommended: [
		{
