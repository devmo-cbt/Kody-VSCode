 ...
 * that data to the shared file-backed stores in ~/.kody/data/ so all platforms
 ...
 *   globalStorageFsPath is still the VSCode-managed path (not ~/.kody/data/),
 ...
 *   to ~/.kody/data/ so that tasks created in VSCode are visible in CLI/JetBrains
